...
convtbl <- read.xls("/share/home3/zstanfie/MetaboliteInference/NHANEScodes_ZS_2020-12-15.xlsx", as.is = TRUE)
...
wtvars <- read.xls("/share/home3/zstanfie/MetaboliteInference/NHANEScodes_ZS_2020-12-15.xlsx", sheet = 2, as.is = TRUE)
wtvars <- wtvars[wtvars$file %in% keepFile,]
# Write Files
map <- read.xls("/share/home3/zstanfie/MetaboliteInference/NHANEScodes_ZS_2020-12-15.xlsx", sheet = 3, as.is = TRUE)
